...
$g.DrawString('证件水印卫士', $fontTitle, $white, 84.0, 205.0)

$fontSub = New-Object System.Drawing.Font('Microsoft YaHei', 26)
$g.DrawString('30 秒为证件加上防护水印', $fontSub, $white, 88.0, 330.0)
...
$g.DrawString('本地处理 · 图片不上传 · 自动去除位置信息 · 免费', $fontTag, $tagBrush, 90.0, 405.0)
